...
object Metadata {
  ...
  final case class ConfigParam(jobID: Long, jobParams: Map[String, String])
  ...
  final case class JobParamRawDtl(sourceName: String,
  ...
  case class SchemaDtl(columnName: String, columnType: String, isNullable: Boolean)
